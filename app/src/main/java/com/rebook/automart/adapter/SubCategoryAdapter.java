...
public class SubCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
              //  Post post = new Post();
                ...
                if(holder instanceof ViewHolder){
                        ...
                        ((ViewHolder) holder).category_title.setText(postsAuto.get(position).getName());
                        ((ViewHolder) holder).category_image.setVisibility(View.GONE);

                        ((ViewHolder) holder).itemCardView.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                        Intent intent = new Intent(context, ProductList.class);
                                        intent.putExtra(SubCategoryActivity.CATEGORY_ID,postsAuto.get(position).getId());
        ...
        public class ViewHolder extends RecyclerView.ViewHolder{
                ...
                @BindView(R.id.category_name)TextView category_title;
