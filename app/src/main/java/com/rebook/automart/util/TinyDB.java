...
public class TinyDB {
   ...
   * <p>
   *
   * @param theFolder the theFolder - the folder path dir you want to save it to e.g
   * "DropBox/WorkImages"
   * @param theImageName the theImageName - the name you want to assign to the image file e.g
   * "MeAtlunch.png"
   */
  ...
  public void putDouble(String key, double value) {
    putStringMethod(key, String.valueOf(value));
  }

  public void putStringMethod(String key, String value) {
