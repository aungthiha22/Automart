...
public class ProductList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        loadData(1);
        GridLayoutManager gridLayoutManagerNew = new GridLayoutManager(ProductList.this,2);
    ...
    public void loadData( final int page){
        ...
        if (NetService.isInternetAvailable(ProductList.this)) {

            //Log.e("Sub Category id","________"+sub_category_id);
            syncPostService.getProductListCategory(intentName, page, new Callback<JsonObject>() {
                @Override
                public void success(JsonObject jsonObject, Response response) {
                    ...
                    if (jsonObject != null) {
                        ...
                        JsonArray jsonArrayNormal = jsonObjectData.get("normal").getAsJsonArray();

                        if (jsonArrayNormal.size() > 0) {

                            emptyView.setVisibility(View.GONE);
                            progressBar.setVisibility(View.GONE);
                            recyclerView.setVisibility(View.VISIBLE);
                            postList = new ArrayList<Product>();
                            for (int i = 0; i < jsonArrayNormal.size(); i++) {
                                Gson gson = new Gson();
                                postList.add(gson.fromJson(jsonArrayNormal.get(i), Product.class));
            ...
            zgToast = new ZgToast(ProductList.this);
            zgToast.setError();
